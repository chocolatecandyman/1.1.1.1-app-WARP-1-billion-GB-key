-- There are some changes in cloudflare licencing and API protocols, because of which they key only works in mobile application & not in PC - Will be fixed soon!!! 
